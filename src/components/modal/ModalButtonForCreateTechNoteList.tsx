...
import { createApiForTechNoteList, updateTechNoteInfoByPk } from "../../apis/tech_note_api";
import { IFormTypeForCreateTechNoteList } from "../../types/tech_note_type";


const ModalButtonForCreateTechNoteList = () => {
  const { isOpen, onOpen, onClose } = useDisclosure();
  const toast = useToast();
  const { handleSubmit, register } = useForm<IFormTypeForCreateTechNoteList>();
  const queryClient = useQueryClient();

  const createMutationForTechNoteInfo = useMutation(createApiForTechNoteList, {
...
export default ModalButtonForCreateTechNoteList;
